...
@ViewScoped
public class ParameterValueListBean {
	...
	public void addParameterValue() throws Exception {
		flora.init();
		flora.addParameterValue(this.parameter, this.name, this.parameterValueParents.toArray(new String[0]), (String[]) this.parameterValueChildren.toArray(new String[0]));
		this.name = null;
